        ...
        insert into DQ.normalize_zameri__dbt_backup ("new_date", "adcostWithTax", "leadWithoutOffline", "leadYaDirect", "leadOrganic", "leadOrganicYa", "leadOrganicGoo", "leadEmail", "leadDirect", "leadPartners", "leadGeoservice", "leadReferal", "leadCallBack", "leadPayYaMaps", "contProdaj", "contClear", "zamer", "viezdPlusDop", "viezdDop", "dogovorAccept", "dogovorAcceptSum", "leadPik")
